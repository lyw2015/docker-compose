...
return [
    ...
    'greeting'                                => '您好，',
    'closing'                                 => '哔——啵——',
    'signature'                               => '记账服务中心 邮件机器人',
    'footer_ps'                               => 'PS: 此消息是由来自 IP :ipAddress 的请求触发的。',

    // admin test
    'admin_test_subject'                      => '来自 记账服务中心 安装的测试消息',
    'admin_test_body'                         => '这是来自 记账服务中心 站点的测试消息，收件人是 :email。',
 ...
 */
    ...
    'invitation_introduction'                 => '您已被邀请在 **:host**创建一个 记账服务中心 帐户。 记账服务中心是一个个人的、自托管的私人财务经理。所有很酷的人都在使用它。',
    'invitation_invited_by'                   => '您已经被“:admin”邀请，这个邀请已经被发送到“:invitee”。这是您，对吗？',
    'invitation_url'                          => '邀请有效期为48小时，可以通过访问 [记账服务中心](:url)来兑现。享受！',

    // new IP
    'login_from_new_ip'                       => '记账服务中心 上有新的登录活动',
    'slack_login_from_new_ip'                 => '新 记账服务中心 登录 IP :ip (:host)',
    'new_ip_body'                             => '记账服务中心 检测到了来自未知 IP 地址的登录活动。如果您从未在下列 IP 地址登录，或上次登录已超过6个月，记账服务中心 会提醒您。',
    ...
    'access_token_created_body'               => '有人（希望是您）刚刚为您的帐户创建了一个新的 记账服务中心 API 访问令牌。',
    'access_token_created_explanation'        => '使用这个令牌，任何人都可以通过记账服务中心 API访问您的所有财务记录。',
    'access_token_created_revoke'             => '如果这不是您的操作，请尽快访问链接撤销该令牌：:url。',

    // registered
    'registered_subject'                      => '欢迎使用 记账服务中心！',
    'registered_subject_admin'                => '一个新用户已注册',
    'admin_new_user_registered'               => '一个新用户已经注册。用户 **:email** 已被授予用户 ID #:id。',
    'registered_welcome'                      => '欢迎来到 [记账服务中心](:address)。收到这封电子邮件即确认您的注册已经完成。耶！',
    ...
    'registered_firefly_iii_link'             => '记账服务中心:',
 ...
 */
    ...
    // new version
    'new_version_email_subject'               => '有新的 记账服务中心 版本可用',

    // email change
    'email_change_subject'                    => '您的 记账服务中心 电子邮件地址已更改',
    'email_change_body_to_new'                => '您或有人访问您的 记账服务中心 帐户已更改您的电子邮件地址。 如果不是您操作的，请忽略并删除。',
    ...
    'email_change_instructions'               => '在您确认该项更改前，您无法使用 记账服务中心。请点击下方链接进行操作。',
    'email_change_undo_link'                  => '若要撤销改动，请点击此链接：',

    // OAuth token created
    'oauth_created_subject'                   => '新的 OAuth 客户端完成创建',
    'oauth_created_body'                      => '有人（希望是您）刚刚使用您的账户创建了一个新的 记账服务中心 API OAuth 客户端。客户端标签是“:name”，回调地址是 `:url`。',
    'oauth_created_explanation'               => '通过该客户端，您的**所有**财务信息都可以通过 记账服务中心 API 来获取。',
    ...
    'reset_pw_warning'                        => '请您**务必**确认打开的链接为真正的 记账服务中心 站点。',

    // error
    'error_subject'                           => '记账服务中心 发生了错误',
    'error_intro'                             => '记账服务中心 v:version 发生了错误：<span style="font-family: monospace;">:errorMessage</span>。',
 ...
 */
    ...
    // report new journals
    'new_journals_subject'                    => '记账服务中心 创建了一笔新的交易|记账服务中心 创建了 :count 笔新的交易',
    'new_journals_header'                     => '记账服务中心 为您创建了一笔交易，您可以在您的 记账服务中心 站点中查看：|记账服务中心 为您创建了 :count 笔交易，您可以在您的 记账服务中心 站点中查看：',
