...
return [
    ...
    'index'                  => '欢迎来到 <strong>记账服务中心</strong>！您可在此页快速概览您的财务状况。如需更多信息， 请前往账户 &rarr; <a href=":asset">资产账户</a>，或者<a href=":budgets">预算</a>及<a href=":reports">报表</a>页面。您也可以继续浏览当前页面。',
    ...
    'reports-index-start'    => '记账服务中心 支持多种不同类型的报表，您可以点击右上方的<i class="fa fa-question-circle"></i>-图标获取更多信息。',
    'reports-index-examples' => '请您务必看看这些示例：<a href=":one">月度财务概览</a>、<a href=":two">年度财务概览</a>，以及<a href=":three">预算概览</a>。',
    'currencies-index'       => '记账服务中心 支持多种货币。默认货币为欧元，您可将其设为美元或其他货币。如您所见，系统已包含了一小部分的货币种类，但您也可自行新增其他货币。修改默认货币并不会改变已有交易的货币，不过，记账服务中心 支持同时使用不同货币。',
