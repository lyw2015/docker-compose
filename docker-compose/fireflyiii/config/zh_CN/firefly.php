 ...
 *
 * This file is part of 记账服务中心 (https://github.com/firefly-iii).
 *
...
return [
    ...
    'two_factor_lost_fix_self'             => '如果这是您自己的 记账服务中心 站点，请阅读<a href="https://docs.firefly-iii.org/faq/other#i-lost-my-two-factor-authentication-codes-and-backup-codes">FAQ页面中的此条目</a>以获取更多帮助。',
    'two_factor_lost_fix_owner'            => '如果这不是您自己的 记账服务中心 站点，请邮件联系站点管理员（<a href="mailto::site_owner">:site_owner</a>）协助您重置两步验证。',
    'mfa_backup_code'                      => '您已使用备用代码登录到 记账服务中心 。 您不能再使用它，因此请将其划掉。',
    ...
    'need_more_help'                       => '如果您在使用 记账服务中心 时需要获取更多帮助，请<a href="https://github.com/firefly-iii/firefly-iii/issues">提交 GitHub 工单</a>。',
    ...
    'cannot_redirect_to_account'           => '记账服务中心 无法重新指向您至正确页面，抱歉。',
    ...
    'invalid_locale_settings'              => '记账服务中心 无法格式化货币金额，因为您的服务器缺少必要的软件包。查看 <a href="https://docs.firefly-iii.org/firefly-iii/advanced-installation/locales/">说明</a>以解决该问题。',
    'quickswitch'                          => '快速切换',
    ...
    'reset_button'                         => '重置',
    'want_to_login'                        => '我想登录',
    'login_page_title'                     => '登录到记账服务中心',
    'register_page_title'                  => '在 记账服务中心 注册',
    'forgot_pw_page_title'                 => '忘记您 记账服务中心 的密码',
    'reset_pw_page_title'                  => '重设您 记账服务中心 的密码',
    ...
    'advanced_options_explain'             => '记账服务中心 的部分页面将高级选项隐藏于此按钮中。当前页面没有需要额外查看的内容，但请一定要留意其他页面！',
    ...
    'attempt_content_help'                 => 'These are all the unsuccessful attempts of this webhook message to submit to the configured URL. After some time, 记账服务中心 will stop trying.',
    ...
    // API access
    'authorization_request'                => '记账服务中心 :version 版授权请求',
    'authorization_request_intro'          => '应用 "<strong>:client</strong>" 正在请求权限以访问您的财务管理功能。是否授权 <strong>:client</strong> 访问这些记录？',
    'authorization_request_site'           => '您将被重定向到 <code>:url</code> ，然后就能够访问您的 记账服务中心 数据。',
    ...
    'back_to_index'                        => '返回列表　',
    'cant_logout_guard'                    => '记账服务中心 无法退出登录。',
    'internal_reference'                   => '内部引用',

    // check for updates:
    'update_check_title'                   => '检查更新',
    'admin_update_check_title'             => '自动检查更新',
    'admin_update_check_explain'           => '记账服务中心 可以自动检查更新。当您启用此设置时，它将与 记账服务中心 更新服务器通讯，查看是否有新版本的 记账服务中心。当有新版时，您将收到通知。您可以使用右边的按钮测试此通知。请在下面选择您是否希望 记账服务中心 检查更新。',
    'check_for_updates_permission'         => '记账服务中心 可自动检查更新，但此功能需要您的许可。请前往<a href=":link">管理页面</a>确认您是否需要启用此功能。',
    'updates_ask_me_later'                 => '稍后再次询问',
    'updates_do_not_check'                 => '不检查更新',
    'updates_enable_check'                 => '启用检查更新',
    'admin_update_check_now_title'         => '立即检查更新',
    'admin_update_check_now_explain'       => '如果您点击此按钮，记账服务中心 将会检查您现在的版本是否为最新版。',
    'check_for_updates_button'             => '立即检查！',
    'update_new_version_alert'             => '发现可用的 记账服务中心 新版本，您正在运行的版本是 :your_version，最新版本是 :new_version（发布于 :date）。',
    ...
    'admin_update_channel_explain'         => '记账服务中心 具有三个更新“通道”，其决定了您在功能、改进和错误修正方面的不同体验。如果您喜欢冒险，请使用“beta”通道；如果您不惧危险，请使用“alpha”通道。',
    ...
    'search'                               => '搜索',
    'search_query'                         => '搜索语句',
    'search_found_transactions'            => '记账服务中心 找到 :count 条交易，用时 :time 秒。|记账服务中心 找到 :count 条交易，用时 :time 秒。',
    'search_found_more_transactions'       => '记账服务中心 找到超过 :count 条交易，用时 :time 秒。',
    'search_for_query'                     => '记账服务中心 正在搜索包含 <span class="text-info">:query</span> 的交易',
 ...
 */
    ...
    'search_box'                                          => '搜索',
    'search_box_intro'                                    => '欢迎使用 记账服务中心 的搜索功能，请输入搜索语句。由于搜索为高级功能，请确保您已阅读过帮助文件。',
    ...
    'instructions_rule_from_bill'                         => '为了匹配交易至您的新账单“:name”，记账服务中心 可以建立一条新规则，对您保存的每一笔交易自动进行检查。您确认下方信息准确无误后，即可保存规则，让 记账服务中心 自动将交易匹配至您的新账单。',
    ...
    'apply_rule_selection_intro'                          => '规则如“:title”一般仅应用于新增的或更新后的交易，但您可要求 记账服务中心 针对已有的单笔或多笔交易执行规则。在您更新一条规则后，且必须应用此规则至其他交易时，即可使用此功能。',
    ...
    'apply_rule_group_selection_intro'                    => '规则组如“:title”一般仅应用于新增的或更新后的交易，但您可要求 记账服务中心 针对已有的单笔或多笔交易执行规则组内的规则。在您更新一个规则组后，且必须应用此组至其他交易时，即可使用此功能。',
    ...
    'rule_trigger_has_no_bill'                            => '无账单交易',
    'rule_trigger_has_any_bill_choice'                    => '有一个（任何）账单',
    'rule_trigger_has_any_bill'                           => '交易有一个（任意个）账单',
 ...
 */
    ...
    'create_rule_for_bill_txt'                            => '您刚刚创建了一个名为“:name”的新账单，恭喜！记账服务中心 可以自动匹配新支出到此账单中。例如，每当您支付租金时，“租金”账单将与此支出挂钩。 这样的话，记账服务中心 可以准确地向你们展示哪些账单将要到期以及哪些账单尚未到期。要实现该功能必须创建一项新的规则。记账服务中心 已经为您填写了一些合理的默认值。请确保它们是正确的。如果这些值是正确的，Frefly III 将自动将正确的支出与正确的帐单关联起来。 请查看触发器以确认他们是否正确，如果触发器不正确，请添加一些正确的触发器。',
    ...
    'dark_mode_preference_help'                 => 'Tell 记账服务中心 when to use dark mode.',
    ...
    'pref_languages'                            => '语言',
    'pref_locale'                               => '区域设置',
    'pref_languages_help'                       => '记账服务中心 支持多语言，请问您倾向于哪个语言？',
    'pref_locale_help'                          => '记账服务中心 允许您配置其他本地设置，例如货币、数字、日期的格式。您的系统可能不支持此列表中的某些条目。记账服务中心 没有为每个区域设置正确的日期格式；请联系开发者进行改进。',
    ...
    'slack_webhook_url_help'                    => '如果您想要 记账服务中心 使用 Slack 通知您，请在此处输入 webhook 地址。否则请留空该字段。 如果您是管理员，您还需要在管理设置中设置此地址。',
    ...
    'purge_data_expl'                           => '“清除”是指“删除已经删除的内容”。在正常情况下，记账服务中心 不会永久删除记录，只是将其隐藏。下面的按钮会将先前“已删除”的记录永久删除。',
    'delete_stuff_header'                       => '删除数据',
    'purge_all_data'                            => '彻底删除所有已删除的记录',
    'purge_data'                                => '彻底清除数据',
    'purged_all_records'                        => '所有已删除的记录已被彻底清除。',
    'delete_data_title'                         => '从 记账服务中心 删除数据',
    'permanent_delete_stuff'                    => '你可以从 记账服务中心 删除数据。使用下列按钮意味着你的数据会从视图中移除并隐藏。这些操作没有撤销按钮，但如果必要的话，你可以从数据库中找回数据，它们可能仍然存在于数据库中。',
    ...
    'delete_your_account_help'                  => '删除您的账户亦将删除所有创建的账户、交易，包括<em>所有</em>您存在 记账服务中心 的内容都将被清除！',
    ...
    'secure_pw_ff'                              => '您在网上使用的密码都一样吗？如果一个网站泄漏了您的密码，黑客将可获取您的所有资料。记账服务中心 需要您选择强大且独特的密码以保护您的财务记录。',
    'secure_pw_check_box'                       => '为了协助您使用安全密码，记账服务中心 可自动检查您的密码过去是否已被盗用。若如此，记账服务中心 建议您不要使用此密码。',
    'secure_pw_working_title'                   => '它是如何运作的？',
    'secure_pw_working'                         => '勾选此复选框后，记账服务中心 会发送您密码的 SHA1 哈希值的前5个字符至 <a href="https://www.troyhunt.com/introducing-306-million-freely-downloadable-pwned-passwords/">Troy Hunt 网站</a> 以检查是否被泄漏。根据 <a href="https://pages.nist.gov/800-63-3/sp800-63b.html">NIST 特殊刊物</a> 的建议，我们将阻止您使用不安全的密码。',
    ...
    'email_verification'                        => '您的旧邮件地址和新邮件地址都将收到一封邮件。出于安全考虑，您在验证新的电子邮件地址前将无法登录。如果您不确定此 记账服务中心 站点是否能发送邮件，请不要使用此功能。如果您是站点管理员，您可以在<a href="admin">管理页面</a>进行测试。',
    ...
    'external_user_mgt_disabled'                => '当 记账服务中心 不负责用户管理或身份验证时，此操作不可用。',
    'external_auth_disabled'                    => '当 记账服务中心 不负责身份验证时，此操作不可用。',
    'delete_local_info_only'                    => "由于 记账服务中心 不负责用户管理和身份验证时，此操作将仅删除 记账服务中心 本地的信息。",
    'oauth'                                     => 'OAuth 授权',
 ...
 */
    ...
    // export data:
    'export_data_title'                         => '从 记账服务中心 导出数据',
    'export_data_menu'                          => '导出数据',
    'export_data_bc'                            => '从 记账服务中心 导出数据',
    'export_data_main_title'                    => '从 记账服务中心 导出数据',
    'export_data_expl'                          => '此链接允许您从 记账服务中心 导出所有交易和元数据。请查看帮助 (右上角的问号 (?) 图标) 获取更多有关信息。',
    ...
    'currencies_intro'                          => '记账服务中心 支持多种货币，您可在此设置并启用。',
    ...
    'not_or_not_yet'                            => '尚未',
    'visit_bill'                                => 'Visit bill ":name" at 记账服务中心',
    ...
    'auto_match_on'                             => '由 记账服务中心 自动匹配',
    'auto_match_off'                            => '未由 记账服务中心 自动匹配',
    ...
    'bill_edit_rules'                           => '记账服务中心 将同时尝试编辑关联于该账单的规则。如果您已自行编辑过该规则，记账服务中心 将不会修改任何内容。|记账服务中心 将同时尝试编辑关联于该账单的:count条规则。如果您已自行编辑过该规则，记账服务中心 将不会修改任何内容。',
    ...
    'cash'                                      => '现金',
    'cant_find_redirect_account'                => '很抱歉，记账服务中心 无法跳转。正在返回主页...',
    'account_type'                              => '账户类型',
    ...
    'reconcile_has_more'                        => '您的 记账服务中心 帐目比您的银行有更多的金钱，有多个选项可应处，请选择并按下 "确认对帐"。',
    'reconcile_has_less'                        => '您的 记账服务中心 帐目比您的银行有更少的金钱，有多个选项可应处，请选择并按下 "确认对帐"。',
    'reconcile_is_equal'                        => '您的 记账服务中心 账目和您的银行账单相符，无须处理，点击“确认对账”来确认输入。',
 ...
 */
    ...
    'to_get_started'                            => '很高兴看到您成功安装 记账服务中心。要开始使用此工具，请输入您主要使用的的银行名称与支票账户余额。别担心，若您有多个账户，可以稍后添加，此处仅为让 记账服务中心 进行初始化设置。',
    'savings_balance_text'                      => '记账服务中心 会自动为您创建储蓄账户。默认情况下，储蓄账户里没有任何资金。但如果您告诉 记账服务中心 相关金额，程序则会按照您的要求进行保存。',
    'finish_up_new_user'                        => '就到这里了！您可按下 <strong>送出</strong> 继续，您将被带至 记账服务中心 的首页。',
    'stored_new_accounts_new_user'              => '太好了！您的新账户已保存。',
    'set_preferred_language'                    => '若您倾向在 记账服务中心 使用其他语言，请于此表示。',
    'language'                                  => '语系',
    ...
    'interest_period_help'                      => '此字段纯粹是装饰性的，不会为您进行计算。事实证明，银行非常狡猾，记账服务中心 永远无法计算正确。',
 ...
 */
    ...
    'invite_new_user_text'                     => 'As an administrator, you can invite users to register on your 记账服务中心 administration. Using the direct link you can share with them, they will be able to register an account. The invited user and their invite link will appear in the table below. You are free to share the invitation link with them.',
    'invited_user_mail'                        => 'Email address',
    'invite_user'                              => 'Invite user',
    'user_is_invited'                          => 'Email address ":address" was invited to 记账服务中心',
    'administration'                           => '管理',
    ...
    'firefly_instance_configuration'           => '记账服务中心 设置',
    'setting_single_user_mode'                 => '单用户模式',
    'setting_single_user_mode_explain'         => '默认情况下，记账服务中心 只接受一 (1) 次来自您自己的注册请求。这是一项安全防护措施，若没有您的批准，其他人将无法使用您的站点，所有的注册请求都将被拒绝。当您取消选中此复选框后，若站点可以访问 (站点接入外网)，则其他人也可以使用您的站点。',
    ...
    'admin_maintanance_expl'                   => '用于 记账服务中心 维护的漂亮按钮',
    ...
    'admin_notification_check_invite_created'  => 'A user is invited to 记账服务中心',
    ...
    'select_transaction_to_link'            => '选择一笔交易来关联此交易。关联目前尚未在 记账服务中心 中使用 (未显示)，但开发者已计划在将来进行改动。您可以使用搜索框来用标题或 ID 选择一笔交易。如果您想要添加自定义关联类型，请访问管理页面。',
    ...
    'no_accounts_imperative_asset'          => '要开始使用 记账服务中心，您需要至少一个资产账户。我们现在就来：',
    ...
    'no_recurring_intro_default'            => '您还目前没有定期交易，使用此功能可以让 记账服务中心 自动为您创建交易。',
    ...
    'warning_duplicates_repetitions'        => '在极少数情况下，日期在此列表上会显示两次，这是由多个重复项目的冲突造成的。记账服务中心 每天只会产生一条交易。',
    ...
    'recurring_never_cron'                  => '用于支持定期交易的计划任务尚未运行。全新安装 记账服务中心 后出现此提示为正常情况，请尽快按照说明进行操作。点击页面右上角的问号 (?) 图标查看帮助页面。',
    ...
    'help_first_date_no_past'            => '表示第一次预计的定期，记账服务中心 不会创建已经过去的交易。',
    'no_currency'                        => '(没有货币)',
    ...
    'help_weekend'                       => '当定期交易发生于周六或周日时，记账服务中心 要如何处理？',
    'do_nothing'                         => '仅创建交易',
 ...
 */
    ...
    'object_groups'                      => '组',
    'object_groups_empty_explain'        => '记账服务中心 的一些项目可以分为组。例如，存钱罐的编辑和创建页面有“组”字段。当您设定了此字段，您可以在此页面编辑组名称和排列顺序。点击右上角的问号 (?) 图标查看帮助页面，获取更多信息。',
